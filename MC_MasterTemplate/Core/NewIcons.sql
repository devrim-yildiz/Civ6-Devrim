...
VALUES	('ICON_CIVILIZATION_MC_OLMEC',				'ICON_ATLAS_MC_OLMEC',			0					),
		...
		-- Devrim civilization and leader icons (using template icons as placeholders)
		('ICON_CIVILIZATION_DEVRIM_MINISTERIUM',	'ICON_ATLAS_MC_OLMEC',			0					),
		('ICON_LEADER_DEVRIM_DER_VISIONAER',		'ICON_ATLAS_MC_PO_NGBE',		0					),
		('ICON_UNIT_DEVRIM_MECHANISIERTE_ELITE_PORTRAIT',	'ICON_ATLAS_MC_WEREJAGUAR',		0			),
		('ICON_UNIT_DEVRIM_MECHANISIERTE_ELITE',	'ICON_ATLAS_MC_WEREJAGUAR',		1					),
		('ICON_BUILDING_DEVRIM_QUANTUM_FABRIK',		'ICON_ATLAS_COLOSSAL_HEAD',		0					);
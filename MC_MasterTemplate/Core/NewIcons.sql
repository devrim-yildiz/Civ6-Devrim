...
VALUES	('ICON_CIVILIZATION_MC_OLMEC',				'ICON_ATLAS_MC_OLMEC',			0					),
		...
		('ICON_LEADER_DEVRIM_SCHICHTLEITER',		'ICON_ATLAS_MC_PO_NGBE',		0					),
		('ICON_UNIT_DEVRIM_STAHLPRAKTIKANTEN_PORTRAIT', 'ICON_ATLAS_MC_WEREJAGUAR', 0				),
		('ICON_UNIT_DEVRIM_STAHLPRAKTIKANTEN',		'ICON_ATLAS_MC_WEREJAGUAR',		1					),

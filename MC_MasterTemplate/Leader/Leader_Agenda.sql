...
INSERT INTO Types
			(Type,									Kind			)
VALUES		('TRAIT_AGENDA_DEVRIM_SCHICHTLEITER',	'KIND_TRAIT'	);
...
VALUES 		('AGENDA_DEVRIM_SCHICHTLEITER',		'LOC_AGENDA_DEVRIM_SCHICHTLEITER_NAME',		'LOC_AGENDA_DEVRIM_SCHICHTLEITER_DESCRIPTION'		);
...
VALUES		('TRAIT_AGENDA_DEVRIM_SCHICHTLEITER',	'LOC_AGENDA_DEVRIM_SCHICHTLEITER_NAME',		'LOC_AGENDA_DEVRIM_SCHICHTLEITER_DESCRIPTION'		);
...
VALUES 		('AGENDA_DEVRIM_SCHICHTLEITER',		'TRAIT_AGENDA_DEVRIM_SCHICHTLEITER'	);
...
VALUES 		('LEADER_DEVRIM_SCHICHTLEITER',	'AGENDA_DEVRIM_SCHICHTLEITER'	);
...
INSERT INTO ExclusiveAgendas
			(AgendaOne,						AgendaTwo					)
VALUES 		('AGENDA_DEVRIM_SCHICHTLEITER',	'AGENDA_CULTURED'			);
...
VALUES		('TRAIT_AGENDA_DEVRIM_SCHICHTLEITER',	'AGENDA_MODIFIER_DEVRIM_UNHAPPY'				),
			('TRAIT_AGENDA_DEVRIM_SCHICHTLEITER',	'AGENDA_MODIFIER_DEVRIM_HAPPY'					);
...
VALUES		('AGENDA_MODIFIER_DEVRIM_UNHAPPY',		'InitialValue',					-5																),
			...
			('AGENDA_MODIFIER_DEVRIM_UNHAPPY',		'StatementKey',					'LOC_DIPLO_WARNING_LEADER_DEVRIM_SCHICHTLEITER_REASON_ANY'		),
			('AGENDA_MODIFIER_DEVRIM_UNHAPPY',		'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_DEVRIM_SCHICHTLEITER_UNHAPPY'				),
			...
			('AGENDA_MODIFIER_DEVRIM_HAPPY',		'StatementKey',					'LOC_DIPLO_KUDO_LEADER_DEVRIM_SCHICHTLEITER_REASON_ANY'			),
			('AGENDA_MODIFIER_DEVRIM_HAPPY',		'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_DEVRIM_SCHICHTLEITER_HAPPY'					);
